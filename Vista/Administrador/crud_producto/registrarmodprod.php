...
<head>
  ...
  <title>Rgistro Producto</title>
</head>

<body>
  <div class="modal fade" id="registrarmodprod" tabindex="-1" aria-labelledby="registrarmodprodLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="registrarmodprodLabel">Registrar Producto</h1>
  ...
  <script>
    ...
    function gestionarOpcionesPorCategoria() {
      ...
      if (['Maquillaje'].includes(selectedCategoria)) {
        ...
        colorselect.setAttribute('required', 'true');
          tallaSelect.setAttribute('required', 'true');
      }
    }
